...
function generate(colors, fonts, prefs, constants) {
    let newConfig = require("./themes/iterm2/base/default.json")    
    let baseConfig = require("./themes/iterm2/base/configBase.json")
    let keybinds = require("./themes/iterm2/base/keybinds.json")
